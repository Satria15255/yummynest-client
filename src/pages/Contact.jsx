    ...
    return (
        <div className="grid bg-cover bg-center w-full h-auto place-items-center mb-12">
            ...
            <div className="flex flex-col md:flex-row justify-center items-center p-1">
                <div className="w-auto md:w-[80vh] h-auto bg-white rounded-3xl px-7 py-7 flex flex-col justify-center my-12 space-y-4 border border-orange-300 rounded">
                ...
                {/* Message form */}
                <section className="w-auto md:w-[80vh] h-auto bg-white px-7 flex flex-col justify-center space-y-2 rounded">
