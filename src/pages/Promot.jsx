...
const Promot = () => {
    ...
    return (
        <section style={{ backgroundImage: `url(${callaction})` }} className='w-full h-[25vh] md:h-[50vh] bg-cover bg-center'>
            <div className='w-full h-[25vh] md:h-[50vh] bg-black/30 flex flex-col justify-center px-6 md:space-y-3'>
